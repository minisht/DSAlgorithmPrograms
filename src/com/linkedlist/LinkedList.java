...
public class LinkedList<T extends Comparable<T>> implements Cloneable {
    ...
    /*Insert at the nth position in the list. Return if the number of
    ...
    /*Append the nodes of the other list to the end.*/
    ...
    /*Split a linked list into 2 equal parts. If there are an odd number
    * of elements, the extra element should be in the first list.*/
    ...
    * the destination linked list as the destination's new head node*/
    ...
    /*Create a new sorted list which is merged from two original sorted lists.*/
    ...
    /*Reverse all nodes in the linked list so that the last node becomes the first node*/
